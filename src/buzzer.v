...
// Latch-and-hold design: any detect pulse triggers a HOLD_CYCLES beep.
// This works with CFAR where detect only fires briefly (~4 cycles per target).
// HOLD_CYCLES=2000 @ 10MHz = 0.2ms beep — clearly audible and fast to simulate.
